...
def main():
    ...
    for text in texts:
        signatures.append(calcula_assinatura(text))
        
    compared_signatures = []
    
    for signature in signatures:
        compared_signatures.append(compara_assinatura(main_signature, 
                                                      signature))
    
    infected = avalia_textos(texts, compared_signatures)
    print("O autor do texto {} está infectado com COH-PIAH.".format(infected))
